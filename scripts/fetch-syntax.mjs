...
const LANGS = [
  'go', 'ruby', 'typescript', 'javascript', 'python3', 'elixir', 'rust', 'sh',
  'fish', 'zsh', 'sql', 'json', 'terraform', 'proto', 'dockerfile', 'toml',
  'yaml', 'markdown', 'css', 'html', 'lua', 'c',
];

const SYNTAX_URL = 'https://raw.githubusercontent.com/micro-editor/micro/master/runtime/syntax/{}.yaml';
